...
var tickSound = new Howl({
		urls: ['assets/pomodoro_tick.ogg', 'assets/pomodoro_tick.mp3'],
		loop: true,
	volume:0.5
});
var turnSound = new Howl({
		urls: ['assets/pomodoro_turn.ogg', 'assets/pomodoro_turn.mp3']
});
var isTickPlaying = false;
var turnSoundDist = 25 / 2;
var ringSound = new Howl({
		urls: ['assets/pomodoro_ring.ogg', 'assets/pomodoro_ring.mp3'],
		volume: 1.0
});
